...
ALTER TABLE "campaign_linkedin" ADD FOREIGN KEY ("campaign_id") REFERENCES "campaigns" ("id");

ALTER TABLE "campaign_infojobs" ADD FOREIGN KEY ("campaign_id") REFERENCES "campaigns" ("id");
