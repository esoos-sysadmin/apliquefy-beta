...
-- CreateEnum
CREATE TYPE "status_campaign" AS ENUM ('paused', 'active', 'inactive');
...
CREATE TABLE "campaigns" (
    ...
    "status" "status_campaign" NOT NULL DEFAULT 'inactive',
...
-- AddForeignKey
ALTER TABLE "campaigns" ADD CONSTRAINT "campaigns_resume_id_fkey" FOREIGN KEY ("resume_id") REFERENCES "resumes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "campaign_linkedin" ADD CONSTRAINT "campaign_linkedin_campaign_id_fkey" FOREIGN KEY ("campaign_id") REFERENCES "campaigns"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "campaign_infojobs" ADD CONSTRAINT "campaign_infojobs_campaign_id_fkey" FOREIGN KEY ("campaign_id") REFERENCES "campaigns"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
